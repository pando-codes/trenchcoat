...
- A **Trenchcoat account** — sign up at [app.trenchcoat.com](https://app.trenchcoat.com).

## Step 1: Create an API key

The plugin authenticates to Trenchcoat using an API key scoped to event ingestion.

1. Go to your Trenchcoat dashboard at [app.trenchcoat.com](https://app.trenchcoat.com).
