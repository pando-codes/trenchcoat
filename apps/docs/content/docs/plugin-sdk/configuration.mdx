...
{
  "api_key": "ct_live_...",
  "api_url": "https://app.trenchcoat.io/api/v1",
  "batch_size": 50,
...
| `api_url` | string | `https://app.trenchcoat.io/api/v1` | Base URL for the Trenchcoat API. Override if you are self-hosting or using a staging environment. |
